...
public class receipt extends javax.swing.JFrame {
    ...
    public receipt(String referenceId, String carBrand, String licensePlate, int totalPrice, javax.swing.JFrame parentDashboard) {
        initComponents();
    ...
    private void processPayment(double change, boolean showConfirmDialog) {
        ...
        try {
            ...
            if (parentDashboard instanceof dashboard) {
                dashboard dash = (dashboard) parentDashboard;
